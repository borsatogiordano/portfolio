...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about" className="flex flex-col gap-2">
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <Markdown className="prose max-w-full text-pretty font-sans text-base text-muted-foreground dark:prose-invert">
            No final de 2023, após 8 anos atuando como designer gráfico, iniciei
            minha carreira como desenvolvedor fullstack, onde já acumulo 1 ano
            de experiência profissional. Desde então, venho desenvolvendo
            aplicações web, mobile e APIs, sempre unindo design, código e
            experiência do usuário. Atualmente, curso Engenharia de Software na
            Uniasselvi.
          </Markdown>
        </BlurFade>
      </section>
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade inView inViewMargin="-10px" delay={BLUR_FADE_DELAY * 9}>
